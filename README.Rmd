...
1. Make drive data available in the `R` session. The `nds_data` is available as part of the \thetool package, but any other data with both geographic and temporal data would also be suitable:
